...
public interface DebeziumSqlserverComponentBuilderFactory {
    ...
    interface DebeziumSqlserverComponentBuilder
         ...
         * fully-qualified names of columns that should be masked by hashing the
         * input. Using the specified hash algorithms and salt.
         * 
         * The option is a: <code>java.lang.String</code> type.
         * 
         * Group: sqlserver
         */
        default DebeziumSqlserverComponentBuilder columnMaskHashWithSalt(
                java.lang.String columnMaskHashWithSalt) {
            doSetProperty("columnMaskHashWithSalt", columnMaskHashWithSalt);
            return this;
        }
        /**
         * A comma-separated list of regular expressions matching
         * fully-qualified names of columns that should be masked with
         * configured amount of asterisk ('') characters.
         * 
         * The option is a: <code>java.lang.String</code> type.
         * 
         * Group: sqlserver
         */
        default DebeziumSqlserverComponentBuilder columnMaskWithdChars(
                java.lang.String columnMaskWithdChars) {
            doSetProperty("columnMaskWithdChars", columnMaskWithdChars);
            return this;
        }
        /**
         * A comma-separated list of regular expressions matching
         * fully-qualified names of columns that should be truncated to the
         * configured amount of characters.
         * 
         * The option is a: <code>java.lang.String</code> type.
         * 
         * Group: sqlserver
         */
        default DebeziumSqlserverComponentBuilder columnTruncateTodChars(
                java.lang.String columnTruncateTodChars) {
            doSetProperty("columnTruncateTodChars", columnTruncateTodChars);
            return this;
        }
        /**
    ...
    class DebeziumSqlserverComponentBuilderImpl
        ...
        protected boolean setPropertyOnComponent(
            ...
            case "columnMaskHashWithSalt": getOrCreateConfiguration((DebeziumSqlserverComponent) component).setColumnMaskHashWithSalt((java.lang.String) value); return true;
            case "columnMaskWithdChars": getOrCreateConfiguration((DebeziumSqlserverComponent) component).setColumnMaskWithdChars((java.lang.String) value); return true;
            case "columnTruncateTodChars": getOrCreateConfiguration((DebeziumSqlserverComponent) component).setColumnTruncateTodChars((java.lang.String) value); return true;
