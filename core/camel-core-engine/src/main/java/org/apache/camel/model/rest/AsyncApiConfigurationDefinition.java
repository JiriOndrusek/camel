...
public class AsyncApiConfigurationDefinition {
     ...
     */
    public AsyncApiConfigurationDefinition component(String componentId) {
     ...
     */
    public AsyncApiConfigurationDefinition apiComponent(String componentId) {
     ...
     */
    public AsyncApiConfigurationDefinition producerComponent(String componentId) {
     ...
     */
    public AsyncApiConfigurationDefinition scheme(String scheme) {
        setScheme(scheme);
        return this;
    }
     ...
     */
    public AsyncApiConfigurationDefinition host(String host) {
        setHost(host);
        return this;
    }
     ...
     * service host.
     */
    public AsyncApiConfigurationDefinition apiHost(String host) {
        setApiHost(host);
        return this;
    }
     ...
     */
    public AsyncApiConfigurationDefinition port(int port) {
        setPort("" + port);
        return this;
    }
     ...
     * To specify the port number to use for the REST service
     */
    public AsyncApiConfigurationDefinition port(String port) {
        setPort(port);
        return this;
    }
     ...
     * load from file or http url.
     */
    public AsyncApiConfigurationDefinition producerApiDoc(String apiDoc) {
     ...
     * that includes a HTTP server.
     */
    public AsyncApiConfigurationDefinition apiContextPath(String contextPath) {
     ...
     * Sets the route id to use for the route that services the REST API.
     */
    public AsyncApiConfigurationDefinition apiContextRouteId(String routeId) {
     ...
     * </ul>
     */
    public AsyncApiConfigurationDefinition apiContextIdPattern(String pattern) {
     ...
     * if <tt>false</tt> then only the current CamelContext is in use.
     */
    public AsyncApiConfigurationDefinition apiContextListing(boolean listing) {
     ...
     */
    public AsyncApiConfigurationDefinition apiVendorExtension(boolean vendorExtension) {
     ...
     * where the deployed web application is deployed using a context-path.
     */
    public AsyncApiConfigurationDefinition contextPath(String contextPath) {
     ...
     */
    public AsyncApiConfigurationDefinition hostNameResolver(RestHostNameResolver hostNameResolver) {
     ...
     */
    public AsyncApiConfigurationDefinition bindingMode(RestBindingMode bindingMode) {
     ...
     * To specify the binding mode
     */
    public AsyncApiConfigurationDefinition bindingMode(String bindingMode) {
     ...
     * code
     */
    public AsyncApiConfigurationDefinition skipBindingOnErrorCode(boolean skipBindingOnErrorCode) {
     ...
     * Rest-DSL configuration of its consumes/produces settings.
     */
    public AsyncApiConfigurationDefinition clientRequestValidation(boolean clientRequestValidation) {
     ...
     */
    public AsyncApiConfigurationDefinition enableCORS(boolean enableCORS) {
     ...
     *            {@link org.apache.camel.CamelContext#resolveDataFormat(String)
     *            resolve}
     */
    public AsyncApiConfigurationDefinition jsonDataFormat(String name) {
     ...
     *            resolve}
     */
    public AsyncApiConfigurationDefinition xmlDataFormat(String name) {
     ...
     * registry.
     */
    public AsyncApiConfigurationDefinition componentProperty(String key, String value) {
     ...
     * registry.
     */
    public AsyncApiConfigurationDefinition endpointProperty(String key, String value) {
        RestPropertyDefinition prop = new RestPropertyDefinition();
        prop.setKey(key);
        prop.setValue(value);
     ...
     * registry.
     */
    public AsyncApiConfigurationDefinition consumerProperty(String key, String value) {
        RestPropertyDefinition prop = new RestPropertyDefinition();
        prop.setKey(key);
        prop.setValue(value);
     ...
     * registry.
     */
    public AsyncApiConfigurationDefinition dataFormatProperty(String key, String value) {
        RestPropertyDefinition prop = new RestPropertyDefinition();
        prop.setKey(key);
        prop.setValue(value);
     ...
     * <tt>api.version</tt>.
     */
    public AsyncApiConfigurationDefinition apiProperty(String key, String value) {
        RestPropertyDefinition prop = new RestPropertyDefinition();
        prop.setKey(key);
        prop.setValue(value);
     ...
     */
    public AsyncApiConfigurationDefinition corsHeaderProperty(String key, String value) {
        RestPropertyDefinition prop = new RestPropertyDefinition();
        prop.setKey(key);
        prop.setValue(value);
     ...
     */
    public AsyncApiConfigurationDefinition corsAllowCredentials(boolean corsAllowCredentials) {
     ...
     */
    public AsyncApiConfigurationDefinition useXForwardHeaders(boolean useXForwardHeaders) {
    ...
    /**
     * Creates a {@link RestConfiguration} instance based
     * on the definition
     *
     ...
     */
    public AsyncApiConfiguration asAsyncApiConfiguration(CamelContext context) throws Exception {
        AsyncApiConfiguration answer = new AsyncApiConfiguration();
        if (component != null) {
...
//        }
     ...
     */
    public static RouteDefinition asRouteApiDefinition(CamelContext camelContext, AsyncApiConfiguration configuration) {
