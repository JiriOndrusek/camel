...
public class CamelNamespace_old {
}

//public class CamelNamespace_old implements Namespace {
//
...
//
//    public CamelNamespace_old(final UShort namespaceIndex, final String namespaceUri, final OpcUaServer server) {
