...
public class FtpConsumerIdempotentKeyChangedIssueTest extends FtpServerTestSupport {
    ...
    private String getFtpUrl() {
        return "ftp://admin@localhost:" + getPort() + "/idempotent?password=admin&readLock=changed" + "&idempotentKey=${file:onlyname}-${file:size}-${date:file:yyyyMMddHHmmss}&stepwise=false";
    }
