...
public class ProducerTest extends SplunkMockTestSupport {
    ...
    @EndpointInject("splunk://tcpLocal")
    protected SplunkEndpoint tcpLocalEndpoint;
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:tcpLocal").to(
                        "splunk://tcp?username=foo&password=bar&tcpReceiverPort=2222&index=myindex&sourceType=testSource&source=test&tcpReceiverLocalPort=12345")
                        .to("mock:tcpresult");
            }
        };
    }
