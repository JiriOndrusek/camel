 ...
 */
@Experimental
public final class IngestPipelineDefinition {
     ...
     * pipeline uses the file name and a consumer pipeline the {@code CamelIngestDocumentId} header. The id is captured
     * before any parse, so a document cannot forge its own identity.
     */
