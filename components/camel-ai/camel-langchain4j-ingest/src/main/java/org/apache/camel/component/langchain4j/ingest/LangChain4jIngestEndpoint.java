...
/**
 * Ingest documents into a LangChain4j embedding store: split into segments, embed and store.
 */
@UriEndpoint(
             firstVersion = "4.23.0",
...
public class LangChain4jIngestEndpoint extends DefaultEndpoint {
    ...
    @UriPath(description = "The name of the ingestion pipeline; stamped into the metadata of every stored segment")
