...
public class WeaviateVectorDbHeaders {
    ...
    @Metadata(description = "Maximum number of objects to consider for the aggregate operation", javaType = "Integer")
    public static final String AGGREGATE_OBJECT_LIMIT = "CamelWeaviateAggregateObjectLimit";
