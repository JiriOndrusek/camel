...
The Undertow component supports 9 options, which are listed below.
...
| *keycloakEnabled* (security) | If enabled and Keycloak security options are defined, endpoints will be secured by Keycloak. | false | boolean
...
| *camel.component.undertow.keycloak-enabled* | If enabled and Keycloak security options are defined, endpoints will be secured by Keycloak. | false | Boolean
