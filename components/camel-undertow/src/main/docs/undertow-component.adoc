...
| *allowedRoles* (security) | List of roles for security reasons. |  | List
| *securityConfig* (security) | Security config for possible implementation of UndertowSecurityProvider |  | Object
...
| *allowedRoles* (security) | todo |  | List
| *securityConfig* (security) | todo |  | Object
| *sslContextParameters* (security) | To configure security using SSLContextParameters |  | SSLContextParameters
|===
